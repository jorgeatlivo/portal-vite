...
import { IconUserHourglass } from './icons/IconUserHourglass';
...
const LivoIcon: React.FC<LivoIconProps> = ({ name, size, color, style }) => {
	...
	const LIVO_ICONS = {
		...
		'user-x': <IconUserX size={size} color={color} />,
		'user-cancel': <IconUserCancel size={size} color={color} />,
		'user-hourglass': <IconUserHourglass size={size} color={color} />,

  ...
  return (
    <section>
      <div className="px-6 pb-3 pt-6">
        <h3 className="heading-md mb-4">{t('hire_offer_claim_modal_title')}</h3>
        <div
        ...
        >
          {t('hire_offer_claim_modal_description', { professionalName })}
        </div>
      </div>
        ...
        <div className="flex flex-row items-center">
          ...
          >
            <p className="action-regular w-full">
              {t('hire_offer_claim_modal_cancel_button')}
            </p>
          </button>
          <button
            type="button"
          ...
          >
            <p className="action-regular w-full">
              {t('hire_offer_claim_modal_accept_button')}
            </p>
          </button>
        </div>
      </div>
